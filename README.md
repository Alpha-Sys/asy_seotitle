...
### Beschreibung ###
Mit diesem Modul können Sie den SEO Title (meta tag title) für Artikel, Kategorien und Inhalte manuell im Admin pflegen.
Wird hier kein Wert gepflegt, so greift die Standard-Logik von Oxid und der normale Titel wird gezogen.
...
Wenn Sie nun im Admin auf Artikel oder Kategorien oder CMS-Seiten gehen, können Sie unten im Hauptfenster den SEO-Title
konfigurieren.